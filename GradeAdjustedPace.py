...
class GAP:
    ...
    def stravaGapParameters(self):
        strava_df = pd.read_csv('Gradient Adjustment/Strava Equal Heartrate.csv', header=None, names=['x', 'y'], index_col=0)
    ...
    def minettiGapParameters(self):
        minetti_df = pd.read_csv('Gradient Adjustment/Minetti-2002 Equal Energy Cost.csv', header=None, names=['x', 'y'], index_col=0)
